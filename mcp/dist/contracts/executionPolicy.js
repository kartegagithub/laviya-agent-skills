...
export function normalizeExecutionPolicy(value) {
    ...
    const workspaceWriteAllowed = policy.WorkspaceWriteAllowed ?? policy.workspaceWriteAllowed;
    ...
    return {
        ...
        allowedCapabilities: policy.AllowedCapabilities ?? policy.allowedCapabilities ?? [],
        forbiddenCapabilities: policy.ForbiddenCapabilities ?? policy.forbiddenCapabilities ?? [],
        workspaceWriteAllowed,
        executionEvidenceRequired: policy.ExecutionEvidenceRequired ?? policy.executionEvidenceRequired ?? false,
